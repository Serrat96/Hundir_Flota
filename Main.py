...
tablero_barco_j1 = Tablero(10, array_barcos_total)'''
...
'''tablero_barco_j1.printTablero()
print(tablero_barco_j1.posicion_barcos)
print(tablero_barco_j1.vidas)'''

jugador1 = Jugador()

jugador1.printTableros()
